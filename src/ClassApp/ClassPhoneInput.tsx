...
interface ClassPhoneInputProps {
  ...
  handlePhoneInputChange: (phoneInputState: PhoneInputState) => void;
}

export class ClassPhoneInput extends Component<ClassPhoneInputProps> {
  render() {
    const { phoneInputState, handlePhoneInputChange } = this.props;
    const refs = [
    ...
    const createOnChangeHandler =
      ...
      (e) => {
        ...
        const isBackspace =
          e.target.value.length < phoneInputState[index].length;
